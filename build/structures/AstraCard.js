        ...
        if (this.theme == 'theme1') {
            ...
            return image.toBuffer('image/png');
                ...
                try {
                    ...
                    console.error('MUSICARD: Thumbnail image failed to load');
                ...
                thumbnailImage = await canvas.loadImage(this.thumbnail, {
                    ...
                    thumbnailImage = canvas.loadImage(`https://i.ibb.co/1r3CBLd/thumbnail.png`);
                })
                ...
                return frame.toBuffer("image/png")
            }   else if (this.theme === "astra1") {
                const progressBarWidth = (validatedProgress / 100) * 670; //BRB AFK
                const circleX = progressBarWidth + 60;
                const image = canvas.createCanvas(1280, 350);
                const ctx = image.getContext('2d');
                const progressBarCanvas = canvas.createCanvas(670, 25);
                ...
                const background = await canvas.loadImage(`https://i.ibb.co/ggy4XNh/gradient.png`);
                ...
                return image.toBuffer('image/png')
                    ...
                    const background = await canvas.loadImage(`https://i.ibb.co/RD7gwjw/gradient2.png`);
                    ...
                    return image.toBuffer('image/png') } 
                        ...
                        const background = await canvas.loadImage(`https://i.ibb.co/ZG00Ksx/gradient3.png`);
            ...
            throw new Error('Invalid theme, must be "theme1" | "theme2" | "theme3" | "theme4" | "theme5" | "astra1" | "astra2" | "astra3"');
        }
    }
}
