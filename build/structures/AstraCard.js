    ...
    async build() {
        ...
        if (this.theme == 'theme1') {
            ...
            return image.toBuffer('image/png');
                ...
                return image.toBuffer('image/png') } else if (this.theme === "astra1") {
                    const progressBarWidth = (validatedProgress / 100) * 670;
                    const circleX = progressBarWidth + 60;
                    const image = canvas.createCanvas(1280, 350);
                    const ctx = image.getContext('2d');
                    ...
                    return image.toBuffer('image/png') }  else {

            throw new Error('Invalid theme, must be "theme1" | "theme2" | "theme3" | "theme4" | "theme5"');
        }
    }
}
